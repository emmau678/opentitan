...
r = [15377, -26226, -16503, 13125, 23887, -6490, -18999, 
  ...
  -22998, -12084, 26475, -1948, -5511, -4698, 1523,   -15727, 
  -16336, 29446, 12214, 14160]
...
def create_tests(dirpath):
    ...
    with open(asm_template_path, 'r') as asm_template, open(exp_template_path, 'r') as exp_template:
        ...
        lib = CDLL('/home/eu233/emmau678/opentitan/hw/ip/otbn/dv/otbnsim/test/ntt_baseline.so')
        ...
        for i in range(256):
            ...
            tmpreplace = tmpcopy.replace("[rj]", str(r_res[i] & 0xFFFF))
    ...
    return find_tests("ntt_baseline/inputoutput")
...
def pytest_generate_tests(metafunc: Any) -> None:
    if metafunc.function is test_fn:
        ...
        # Create all of the input/output files in the /ntt_baseline directory
        tests += create_tests("test/ntt_baseline")
