...
def pytest_generate_tests(metafunc: Any) -> None:
    if metafunc.function is test_fn:
        ...
        ## In this repository, we have simply uploaded 100 input/output files that we generated from the test vector files
        ...
        ## The input/output files can be found in ntt_baseline_vectors_test/inputoutput/
        ####

        #r_inps = read_vectors('/home/eu233/emmau678/opentitan/hw/ip/otbn/dv/otbnsim/test/ntt_test_vectors/ntt_input_1024.txt')
        #r_outs = read_vectors('/home/eu233/emmau678/opentitan/hw/ip/otbn/dv/otbnsim/test/ntt_test_vectors/ntt_output_1024.txt')
        
        #for i in range(100):
         #   random_index = random.randint(0, len(r_inps) - 1)
            # Create all of the input/output files in the /testadd directory
          #  create_tests("test/ntt_baseline_vectors_test", r_inps[random_index], r_outs[random_index], random_index)
        
        tests += find_tests("ntt_baseline_vectors_test/inputoutput")
