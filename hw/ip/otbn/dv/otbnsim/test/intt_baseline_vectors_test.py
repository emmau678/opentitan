...
def pytest_generate_tests(metafunc: Any) -> None:
    if metafunc.function is test_fn:
        ...
        ## The input/output files can be found in intt_baseline_vectors_test/inputoutput/
        ####
        ...
        #for i in range(100):
         #   random_index = random.randint(0, len(r_inps) - 1)
          ...
          #  create_tests("test/intt_baseline_vectors_test", r_inps[random_index], r_outs[random_index], random_index)
        
        tests += find_tests("intt_baseline_vectors_test/inputoutput")
